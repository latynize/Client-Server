...
('Sofia', 'Moreno',null , 1, 'sofia.moreno@bwb.de', '+493344556677', '2023-03-03', 4, 1, 3),
('Tariq', 'Khalid',null , 1, 'tariq.khalid@bwb.de', '+491234567899', '2023-04-04', 5, 1, 1),
('Yasmin', 'Akhtar',null , 1, 'yasmin.akhtar@bwb.de', '+499876543298', '2023-05-05', 3, 1, 3),
('Dante', 'Rossi',null , 1, 'dante.rossi@bwb.de', '+491122334466', '2023-06-06', 4, 1, 3),
('Sophie', 'Müller',null , 1, 'sophie.mueller@bwb.de', '+491234567891', '2022-07-07', 1, 3, 2),
('Max', 'Schmidt',null , 1, 'max.schmidt@bwb.de', '+499876543211', '2022-02-02', 1, 3, 2),
('Lina', 'Hofmann',null , 1, 'lina.hofmann@bwb.de', '+491122334466', '2022-03-03', 1, 3, 2),
('Alex', 'Weiss',null , 1, 'alex.weiss@bwb.de', '+492233445567', '2022-04-04', 1, 3, 2),
('Nina', 'Lehmann',null , 1, 'nina.lehmann@bwb.de', '+493344556678', '2022-05-05', 1, 3, 2),
('Elias', 'Schulz',null , 0.5, 'elias.schulz@bwb.de', '+494455667789', '2022-06-06', 4, 2, 4),
('Anna', 'Koch',null , 0.5, 'anna.koch@bwb.de', '+495566778890', '2022-07-07', 5, 2, 4),
('Luca', 'Wagner',null , 0.5, 'luca.wagner@bwb.de', '+496677889901', '2022-08-08', 4, 2 ,5),
('Liam', 'Bauer',null , 0.5, 'liam.bauer@bwb.de', '+497788990012', '2022-09-09', 5, 2, 5),
('Maya', 'Müller',null , 0.5, 'maya.mueller@bwb.de', '+498899001123', '2022-10-10', 5, 2, 6),
('Oliver', 'Schneider',null , 0.75, 'oliver.schneider@bwb.de', '+499900112234', '2022-11-11', 2, 1, 2),
('Elena', 'Fischer',null , 0.75, 'elena.fischer@bwb.de', '+490011223345', '2022-12-12', 5, 1, 2),
('Paul', 'Vogel',null , 0.5, 'paul.vogel@bwb.de', '+491122334467', '2023-01-01', 3, 1, 1),
('Sophia', 'Klein',null , 0.5, 'sophia.klein@bwb.de', '+492233445568', '2023-02-02', 5, 1, 3),
('Finn', 'Berg',null , 0.5, 'finn.berg@bwb.de', '+493344556679', '2023-03-03', 4, 1, 3),
('Emma', 'Schmitt',null , 0.25, 'emma.schmitt@bwb.de', '+491234567890', '2023-04-04', 5, 1, 1),
('Leon', 'Wagner',null , 0.25, 'leon.wagner@bwb.de', '+499876543291', '2023-05-05', 3, 1, 3),
('Mia', 'Huber',null , 0.8, 'mia.huber@bwb.de', '+491122334467', '2023-06-06', 4, 1, 3);
